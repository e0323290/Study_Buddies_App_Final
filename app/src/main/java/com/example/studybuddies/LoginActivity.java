                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (task.getResult().getAdditionalUserInfo().isNewUser()) {
                                ...
                                //When user i registered store user info in firebase realtime database too
                                //using Hashmap
                                ...
                                hashMap.put("onlineStatus", "online"); //add later (e.g. edit profile)
                                hashMap.put("typingTo", "noOne"); //add later (e.g. edit profile)
