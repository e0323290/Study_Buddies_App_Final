...
import com.example.studybuddies.adapters.AdapterComments;
import com.example.studybuddies.models.ModalComment;
...
public class PostDetailActivity extends AppCompatActivity {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot ds: dataSnapshot.getChildren()) {
                    ModalComment modalComment = ds.getValue(ModalComment.class);

                    commentList.add(modalComment);
    ...
    private void showMoreOptions() {
        //creating popup menu having the option of delete, will add more options later
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds: dataSnapshot.getChildren()) {
                    ...
                    //if there is no image (pImage equals("noImage") then hide ImageView
                    if (pImage.equals("noImage")) {
                        //hide imageview
